            ...
            <Table stickyHeader style={{ borderCollapse: 'collapse' }}>
              <StyledTableHead backgroundColor="#DEF5FF" borderLeft="none">
                <TableRow>
                  ...
                  {pageFields?.find((x) => x.FieldId === 'IS_IT_P_StaffName')
                    ?.IsShow && (
                    <StyledTableHeaderCell
                      color="#000000A6"
                      style={{ padding: '5px 15px' }}
                  ...
                  {pageFields?.find((x) => x.FieldId === 'IS_IT_P_Department')
                    ?.IsShow && (
                    <StyledTableHeaderCell
                      color="#000000A6"
                      style={{ padding: '5px 15px' }}
                  ...
                  {pageFields?.find((x) => x.FieldId === 'IS_IT_P_Designation')
                    ?.IsShow && (
                    <StyledTableHeaderCell
                      color="#000000A6"
                      style={{ padding: '5px 15px' }}
                ...
                <TableBody>
                  {notiStaffList.map((row, rowIndex) => (
                    <StyledTableRow key={rowIndex}>
                      ...
                      {pageFields?.find(
                        (x) => x.FieldId === 'IS_IT_P_Department'
                      )?.IsShow && (
                        <StyledTableBodyCell>
                          {row?.departmentName}
                        </StyledTableBodyCell>
                      ...
                      {pageFields?.find(
                        (x) => x.FieldId === 'IS_IT_P_Designation'
                      )?.IsShow && (
                        <StyledTableBodyCell>
                          {row?.designationName}
                        </StyledTableBodyCell>
