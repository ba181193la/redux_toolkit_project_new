...
import VisitorTable from './Datatable/II_RL_VisitorTable';
import WitnessTable from './Datatable/II_RL_WitnessTable';
import AttachmentTable from './Datatable/II_RL_AttachmentTable';
...
const IncidentDetails = () => {
  ...
  const fields = fieldsData?.Data?.Menus?.filter((item) => item.MenuId === 24) || [];
