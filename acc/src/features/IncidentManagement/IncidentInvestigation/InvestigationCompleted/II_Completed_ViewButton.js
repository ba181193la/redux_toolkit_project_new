...
import { Box, Accordion, AccordionSummary, Tooltip } from '@mui/material';
import {
  FlexContainer,
  StyledImage,
  StyledTypography,
...
import II_CL_IncidentInvestigation from '../../IncidentCommon/IncidentInvestigationDetails';

// import II_CL_IncidentApprovalDetails from './Accordion/II_CL_IncidentApprovalDetails';
import II_CL_IncidentDetails from '../../IncidentCommon/IncidentDetails';

import II_CL_IncidentApprovalDetails from '../../IncidentCommon/IncidentApprovalDetails';
...
var reportIncidentSafe = reportIncident || {};
  ...
  const handlePrint = () => {
      try {
        ...
        const pdfFileName = 'Incident_Investigation_completed.pdf';
        const margin = 40;
    ...
    <FlexContainer style={{ flexDirection: 'column', width: '100%' }}>
      ...
      <FlexContainer style={{ backgroundColor: '#fff' }}>
        ...
        <Box p={3} paddingTop={0} style={{ width: '-webkit-fill-available' }} >
          ...
          <II_CL_IncidentDetails sx={{ marginBottom: '10px' }} />         
          <II_CL_IncidentApprovalDetails sx={{ marginBottom: '10px' }} />
...
export default II_Completed_ViewButton;
