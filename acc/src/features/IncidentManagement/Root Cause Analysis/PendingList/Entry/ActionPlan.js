...
import { setFishBoneAttachmentData,setAttachmentData } from '../../../../../redux/features/mainMaster/incidentRcaSlice.js';
...
export default function ActionPlan({
  ...
  const handleFileChange = (event) => {
    ...
    dispatch(setAttachmentData([...incidentRCA_Attachments, ...newFileDataArray]));
  };
