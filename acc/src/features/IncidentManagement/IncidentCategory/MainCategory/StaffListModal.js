...
const StaffListModal = ({
  ...
  const staffListColumnsList = [
    ...
    {
      id: 'EmployeeId',
      translationId: 'IM_IC_MC_EmployeeId',
      isShow: pageFields?.find((x) => x.FieldId === 'IS_HL_P_EmployeeId')
        ?.IsShow,
    },
    {
      id: 'StaffName',
      translationId: 'IM_IC_MC_StaffName',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_MC_P_StaffName')
        ?.IsShow,
    },
    {
      id: 'Department',
      translationId: 'IM_IC_MC_Department',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_MC_P_Department')
        ?.IsShow,
    },
    {
      id: 'PrimaryDesignation',
      translationId: 'IM_IC_MC_Designation',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_MC_P_Designation')
        ?.IsShow,
    },
  ];
