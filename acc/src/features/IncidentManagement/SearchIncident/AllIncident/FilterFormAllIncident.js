...
const FilterFormAllIncident = ({ fields, handleToggleFilter, labels }) => {
  ...
  const initialValues = {
    ...
    year: reportingYear,
    OverallTATCompliance: overallTaT,
  ...
  const fieldsConfig = [
    ...
    {
      fieldId: 'SI_S_OverallTATCompliance',
      translationId: 'IM_SI_OverallTATCompliance',
      label: 'Overall TAT Compliance',
      component: 'Dropdown',
      name: 'OverallTATCompliance',
      options: pageLoadData?.Data?.Result.OverAllTATCompliance?.map((data) => ({
        text: data.Value,
        value: data.Value,
      })),
    },
        ...
        onSubmit={async (values) => {
          dispatch(
            setFilters({
              ...
              overallTaT: values.OverallTATCompliance,
...
export default FilterFormAllIncident;
