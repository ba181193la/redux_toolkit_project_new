...
import LikelihoodReorderTable from './LikelihoodReorderTable'
import {
  useGetFieldsQuery,
  useGetLabelsQuery,
...
const ReorderIncidentType = () => {
  ...
  const tableColumnList = [
    // { id: 'Facility', translationId: 'Facility', isSelected: true },
    {
      ...
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_L_P_Likelihood')?.IsShow,
    },
    {
      id: 'LikelihoodDefinition',
      translationId: 'IM_IRLC_L_Definition',
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_L_P_Definition')?.IsShow,
    },
    {
      id: 'Score',
      translationId: 'IM_IRLC_L_Score',
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_L_P_Score')?.IsShow,
    },
  ];
