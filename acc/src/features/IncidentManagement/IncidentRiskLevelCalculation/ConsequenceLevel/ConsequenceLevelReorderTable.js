...
import { useGetCategoryDetailsQuery, useGetConsequencelevelDetailsQuery, useReorderCategoryAffectedMutation, useReorderConsequenceLevelMutation, useUpdateConsequenceLevelMutation } from '../../../../redux/RTK/incidentRiskLevelApi';
...
const DraggableTable = ({
  ...
  useEffect(() => {
    if (getConseqenceLevelData?.Records) {
      setTableData(getConseqenceLevelData?.Records);
    }
