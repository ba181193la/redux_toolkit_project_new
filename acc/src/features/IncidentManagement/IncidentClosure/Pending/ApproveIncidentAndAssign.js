...
const ApproveIncidentAndAssign = ({ columns, labels, onUpdateTableData  }) => {
  ...
  const handleSave = (r) => {
    if (r.Designation && r.DepartmentName && r.Comments) {
      const RowNo = r.RowNo;
...
export default ApproveIncidentAndAssign;
