...
import IC_Pending_ICE_IncidentDetails from './IC_Pending_ICE_IncidentDetails';
import PrintFileIcon from '../../../../assets/Icons/PrintFileIcon.png';
import IC_Pending_ICE_IncidentApprovalDetails from './IC_Pending_ICE_IncidentApprovalDetails';
import IC_Pending_ICE_IncidentClosure from './IC_Pending_ICE_IncidentClosure';

const IC_Pending_EditAction = () => {
      ...
      <FlexContainer style={{ backgroundColor: '#fff' }}>
        <Box p={3} paddingTop={0}>
          ...
          >
            ...
            <IC_Pending_ICE_IncidentDetails />
          </Accordion>
          ...
          >
            ...
            <IC_Pending_ICE_IncidentApprovalDetails />
          </Accordion>
...
export default IC_Pending_EditAction;
