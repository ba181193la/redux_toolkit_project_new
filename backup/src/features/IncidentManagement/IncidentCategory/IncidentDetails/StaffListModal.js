...
const StaffDetailListModel = ({
  ...
  const staffListColumnsList = [
    ...
    {
      id: 'EmployeeId',
      translationId: 'IM_IC_ID_EmployeeId',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_ID_P_EmployeeId')
        ?.IsShow,
    },
    {
      id: 'StaffName',
      translationId: 'IM_IC_ID_StaffName',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_ID_P_StaffName')
        ?.IsShow,
    },
    {
      id: 'Department',
      translationId: 'IM_IC_ID_Department',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_ID_P_Department')
        ?.IsShow,
    },
    {
      id: 'PrimaryDesignation',
      translationId: 'IM_IC_ID_Designation',
      isShow: pageFields?.find((x) => x.FieldId === 'IC_ID_P_Designation')
        ?.IsShow,
    },
  ];
