export const columnsMapping = [
    ...
    {
      id: 'IncidentNo',
      fieldId: 'IC_P_IncidentNumber',
      translationId: 'IM_IC_IncidentNumber',
      isSelected: true,
    },
    {
      id: 'IncidentDateTime',
      fieldId: 'IC_P_IncidentDate',
      translationId: 'IM_IC_IncidentDate',
      isSelected: true,
    },
    {
      id: 'IncidentDetail',
    ...
    {
      id: 'IsSentinel',
      fieldId: "IC_P_IsSentinel",
      translationId: 'IM_IC_IsSentinel',
      isSelected: true,
    },
    {
      id: 'DepartmentName',
    ...
    {
      id: 'RCAStatus',
      fieldId: "IC_P_RCAStatus",
      translationId: "IM_IC_RCAStatus",         //table heading not visible
      isSelected: true,
    },
    // {
    //   id: 'SubCategoryCode',
    ...
    // },
    {
      ...
      fieldId: "IC_P_RequestReceivedDate",
      translationId: 'IM_IC_RequestReceivedDate',
      isSelected: true,
    },
    // {
    //   id: 'AddedEditedDate',
    //   fieldId: 'IA_P_Added/EditedDate',
    //   translationId: 'IM_IC_Added/EditedDate',  
    //   isSelected: true,
    // },
    {
      id: 'ReportedDate',
      fieldId: "IC_P_ReportedDate",
      translationId: 'IM_IC_ReportedDate',
      isSelected: true,
    },
    {
      id: 'IncidentStatus',
      fieldId: "IC_P_IncidentStatus",
      translationId: 'IM_IC_IncidentStatus',
      isSelected: true,
    },
    {
      id: 'TATCompliance',
      fieldId: "IC_P_TATCompliance",
      translationId: 'IM_IC_TATCompliance',
      isSelected: true,
    },
    ...
    //   id: 'AddedEditedBy',
    //   fieldId: "IA_P_Added/EditedDate",
    //   translationId: 'IM_IC_Added/EditedBy',
    //   isSelected: true,
    // },
    ...
    {
      id: 'RootCauses',
      fieldId: "IC_P_RootCauses",
      translationId: 'IM_IC_RootCauses',
      isSelected: true,
    },
    // {
    //   id: 'IncidentStatus',
    //   fieldId: "IC_P_IncidentRiskLevel",
    //   translationId: 'IM_IC_IncidentRiskLevel',
    //   isSelected: true,
    // },
    {
      id: 'ContributingDepartment',
    ...
    //   id: 'IncidentStatus',
    //   fieldId: "IC_P_IncidentRiskLevel",
    //   translationId: 'IM_II_IncidentStatus',
    //   isSelected: true,
    // },
    // {
    //   id: 'IncidentStatus',
    ...
    {
      id: 'CompletedBy',
      fieldId: "IC_P_CompletedBy",
      translationId: 'IM_IC_CompletedBy',
      isSelected: true,
    },
    {
      id: 'HarmLevel',
