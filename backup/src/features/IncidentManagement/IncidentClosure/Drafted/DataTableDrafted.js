...
const DataTableDrafted = ({
  ...
  const handleClick = (incidentId,IncidentClosureId) => {
    window.open(`/IncidentManagement/IncidentClosureEntryDrafted/${incidentId}/${IncidentClosureId}`, '_blank');
  };
                       ...
                       <ActionCell>
                         ...
                         >
                           <StyledImage 
                             ...
                             width="12.5px"
                             src={EditIcon}
                             onClick={() => handleClick(row.IncidentId,row.IncidentClosureId)}
                             alt="Edit"
                           />
...
export default DataTableDrafted;
