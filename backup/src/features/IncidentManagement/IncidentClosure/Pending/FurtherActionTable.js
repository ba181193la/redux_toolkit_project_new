...
const AdditionalStafftable = ({ columns, labels, onDataChange }) => {
  ...
  const handleSave = (r) => {
    console.log('r', r);
    if (r.AssignedTask && r.DepartmentName) {
      const RowNo = r.RowNo;
  ...
  const handleInputChange = (value, field, rowId) => {
    console.log('Updating row:', rowId, 'Field:', field, 'New Value:', value);
    const updatedRows = [...tableData];
    updatedRows[rowId][field] = value;
    setTableData(updatedRows);
    
  };
  const handleInputChangeText = (e, rowId, field) => {
                    ...
                    <>
                      ...
                      <StyledTableBodyCell>
                        <TextField
                          ...
                          onChange={(e) =>
                            handleInputChangeText(e, row.RowNo, 'AssignedTask')
                          }
                          sx={{
                      ...
                      <DatePicker
                        ...
                        onChange={(newValue) =>
                          handleInputChange(newValue, 'TargetDate', index)
                        }
                        disabled={!row.isEditable}
                        format="dd/MM/yyyy"
                        renderInput={() => null}
