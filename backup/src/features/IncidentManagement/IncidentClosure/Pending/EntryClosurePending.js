        ...
        switch (table.id) {
          ...
          case 'Approval':
            Object.assign(tableConfig, {
              ...
              didParseCell: (data) => {
                if (data.cell.raw.innerText === 'Approved' || data.cell.raw.innerText === 'Skipped Investigation' || data.cell.raw.innerText === 'Completed' || data.cell.raw.innerText === 'Fill RCA') {
                  data.cell.styles.textColor = [0, 128, 0]; // Apply green color for both label and value
                }
                // If the cell has the 'bold-cell' class, make the text bold
                if (data.cell.raw.classList.contains('bold-cell')) {
                  data.cell.styles.fontStyle = 'bold';
                }
              },
...
export default EntryClosurePending;
