...
import ContributingFactorsTable from './Tables/ContributingFactorsTable';
import SingleTable from './Tables/SingleTable';
import ReoccurrenceTable from './Tables/ReoccurrenceTable';
...
import { useGetIncidentDetailsPendfingByIdQuery } from '../../../../redux/RTK/incidentInvestigationApi';
...
import DynamicViewFormBuilder from '../../IncidentCommon/DynamicViewFormBuilder';
import {
...
const ClosureEntry = () => {
  ...
  console.log('closure view dat', entryData);
  ...
  const incidentRiskLevelClosure = entryData?.incidentRiskLevelClosure;
  const contributingFactors = entryData?.contributingFactors || [];
  ...
  useEffect(() => {
    const mainCategoryId = entrydetails?.Data?.MainCategoryId;
    const subCategoryId = entrydetails?.Data?.SubCategoryId;
    const incidentDetailId = entrydetails?.Data?.IncidentDetailId;
  console.log('mainCategoryId',mainCategoryId)
    if (mainCategoryId && subCategoryId && incidentDetailId) {
        ...
        <FlexContainer style={{ backgroundColor: '#fff' }}>
          <Box paddingTop={0} style={{ width: '-webkit-fill-available' }}>
              ...
              <FormContainer style={{ marginBottom: '20px' }}>
                <FlexContainer flexDirection={'column'}>
                  <Grid container spacing={2} p={2} style={{ padding: '0px' }}>
                    <Grid item xs={12} key="IncidentType">
                      <Box display="flex" alignItems="center">
                        ...
                        >
                          ...
                          <Tooltip title="View Definition">
                            <IconButton
                              size="small"
                              onClick={() => openModalForField('IncidentType')}
                              style={{
                                marginLeft: '8px',
                                padding: '2px',
                                color: '#3498DB',
                        ...
                        <StyledTypography style={{ width: '70%' }}>
                          {entryData['IncidentType'] ?? ''}
                        </StyledTypography>
                      </Box>
                    </Grid>

                    <Grid item xs={6} key="MainCategory">
                      <FormLabel>
                        {getlabel(
                          configs.IncidentApproval?.find(
                            (f) => f.name === 'MainCategory'
                          )?.translationId,
                          filterIncidentApprovalLabels,
                          i18n.language
                        )}
                    ...
                    <Grid item xs={6} key="SubCategory">
                      <FormLabel>
                        {getlabel(
                          configs.IncidentApproval?.find(
                    ...
                    <Grid item xs={12} key="IncidentDetail">
                      <Box display="flex" alignItems="center">
                        <FormLabel
                          style={{ width: '30%', marginRight: '16px' }}
                        >
                        ...
                        <StyledTypography style={{ width: '70%' }}>
                          {entryData['IncidentDetail'] ?? ''}
                        </StyledTypography>
                      </Box>
                    </Grid>

                    <Grid item xs={12} key="ClinicalType">
                      <Box display="flex" alignItems="center">
                        <FormLabel
                          style={{ width: '30%', marginRight: '16px' }}
                        >
                          ...
                          <Tooltip title="View Definition">
                            <IconButton
                              size="small"
                              onClick={() => openModalForField('ClinicalType')}
                              style={{
                                marginLeft: '8px',
                                padding: '2px',
                                color: '#3498DB',
                        ...
                        <StyledTypography style={{ width: '70%' }}>
                          {entryData['ClinicalType'] ?? ''}
                        </StyledTypography>
                      </Box>
                    </Grid>

                    <Grid item xs={12} key="JAWDALevel">
                      <Box display="flex" alignItems="center">
                        <FormLabel
                          style={{ width: '30%', marginRight: '16px' }}
                        >
                          ...
                          <Tooltip title="View Definition">
                            <IconButton
                              size="small"
                              onClick={() =>
                                openModalForField('JAWDAIncidentLevel')
                              }
                              style={{
                                marginLeft: '8px',
                                padding: '2px',
                      ...
                      <Grid item xs={12} mt={2}>
                        ...
                        <Box mb={2}>
                          <DynamicViewFormBuilder
                            ...
                            formValues={mainCategoryFormValueData}
                          />
                        </Box>
                        <Box mb={2}>
                          <DynamicViewFormBuilder
                            formData={subCategoryQuestionsData}
                            formValues={subCategoryFormValueData}
                          />
                        </Box>
                        <Box mb={2}>
                          <DynamicViewFormBuilder
                            formData={incidentQuestionsData}
                            formValues={incidentDetailFormValueData}
                          />
                        </Box>
                      </Grid>
                    )}
                    <Grid item xs={12} key="IncidentReason">
                      <Box display="flex" alignItems="center">
                        <FormLabel
                          style={{ width: '30%', marginRight: '16px' }}
                        >
                          {getlabel(
                            configs.IncidentApproval?.find(
                              (f) => f.name === 'IncidentReason/RootCause'
                            )?.translationId,
                            filterIncidentApprovalLabels,
                            i18n.language
                          )}
                    ...
                    <Grid item xs={12} key="LessonLearned">
                      <Box display="flex" alignItems="center">
                        <FormLabel
                          style={{ width: '30%', marginRight: '16px' }}
                        >
                        ...
                        <StyledTypography style={{ width: '70%' }}>
                          {entryData['LessonLearned'] ?? ''}
                        </StyledTypography>
                      </Box>
                    </Grid>

                    <Grid item xs={6} key="IncidentHarmLevel">
                      <FormLabel>
                        {getlabel(
                          configs.IncidentApproval?.find(
                            (f) => f.name === 'IncidentHarmLevel'
                          )?.translationId,
                          filterIncidentApprovalLabels,
                          i18n.language
                        )}
                        <Tooltip title="View Definition">
                          <IconButton
                            size="small"
                            onClick={() =>
                              openModalForField('IncidentHarmLevel')
                            }
                            style={{
                              marginLeft: '8px',
                              padding: '2px',
                    ...
                    <Grid item xs={6} key="MedicationIncidentHarmLevel">
                      <FormLabel>
                        {getlabel(
                          configs.IncidentApproval?.find(
                            (f) => f.name === 'MedicationIncidentHarmLevel'
                          )?.translationId,
                          filterIncidentApprovalLabels,
                          i18n.language
                        )}
                  ...
                  <>
                    ...
                    >
                      <Box>
                        <StyledFormLabel style={{ marginBottom: '10px' }}>
                          {getlabel(
                            filteredIncidentApprovalConfig.find(
                              (config) =>
                  ...
                  >
                    ...
                    <StyledGridItem>
                      <SingleTable
                        columns={configs.ReportExternalBody}
                        labels={filterIncidentApprovalLabels}
            ...
            <StyledFormLabel style={{ margin: '10px 0px 10px 0px' }}>
              {getlabel(
                filteredIncidentApprovalConfig.find(
                  (config) => config.name === 'IncidentHistory'
                )?.translationId,
                filterIncidentApprovalLabels,
                i18n.language
              )}
            ...
            <IncidentHistory
              columns={configs.IncidentHistorylabel}
              labels={filterIncidentApprovalLabels}
            ...
            <NotificationHistory
              columns={configs.NotificationHistorylabel}
              labels={filterIncidentApprovalLabels}
