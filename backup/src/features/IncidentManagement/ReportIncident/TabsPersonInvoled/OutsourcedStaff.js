      ...
      <FormContainer>
        <StyledGridContainer>
          <Grid item xs={12} sm={4}>
            <Label bold value="Outsourced Staff Id:" isRequired />
            <Field
              name="patientid"
              as={TextField}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Outsourced Staff Name:" isRequired />
            <Field
              name="patientname"
              as={TextField}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Outsourced Staff Age:" isRequired />
            <Field
              name="patientname"
              as={TextField}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Outsourced Staff Gender:" isRequired />
            <Field
              name="gender"
              as={Select}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Department / Unit:" isRequired />
            <Field
              name="department"
              as={Select}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Company Name:" isRequired />
            <Field
              name="patientname"
              as={TextField}
              fullWidth
