    ...
    <FlexContainer flexDirection="column" width="100%" margin="10px 0 0 0">
      ...
      <FormContainer>
        <StyledGridContainer>
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Physician Name:" isRequired />
            <Field name="name" as={TextField} fullWidth variant="outlined" />
          </StyledGridItem>
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Speciality:" isRequired />
            <Field name="name" as={TextField} fullWidth variant="outlined" />
          </StyledGridItem>
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Diagnosis:" isRequired />
            <Field
              name="briefDesc"
              as={TextField}
              fullWidth
          ...
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Visit Id:" isRequired />
            <Field name="name" as={TextField} fullWidth variant="outlined" />
          </StyledGridItem>
          <StyledGridItem item xs={12} sm={4}>
            <Label bold value="Physician Notified:" isRequired />
            <Field
              name="department"
              as={Select}
              fullWidth
            ...
            >
              <MenuItem value="nearmiss">Select</MenuItem>
              <MenuItem value="incident">Yes</MenuItem>
              <MenuItem value="incident">No</MenuItem>
            </Field>
          </StyledGridItem>
        </StyledGridContainer>
      </FormContainer>
