...
import StaffDetailListTable from './StaffDetailListTable';
import LoadingGif from '../../../../../../assets/Gifs/LoadingGif.gif';

const StaffDetailsListPopup = ({
  setSelectedIndex,
  handleSelectRow,
  openStaffModal,
  setOpenStaffModal,
  ...
  const { selectedMenu, userDetails, roleFacilities, isSuperAdmin } =
...
export default StaffDetailsListPopup;
