...
import IncidentRCA from '../../IncidentCommon/incidentRCA';
import IncidentClosure from '../../IncidentCommon/incidentClosure';
...
const DetailSubmittedTableEntry = () => {
  ...
  const handlePrint = () => {
    try {
      ...
      const pdfFileName = 'SubmittedByMe.pdf';
      const margin = 40;
...
export default DetailSubmittedTableEntry;
