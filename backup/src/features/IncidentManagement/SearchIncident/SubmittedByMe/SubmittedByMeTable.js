    ...
    <FlexContainer flexDirection="column">
      <TableContainer component={Paper} style={{ border: '1px solid #99cde6' }}>
        <Table stickyHeader style={{ borderCollapse: 'collapse' }}>
          <StyledTableHead>
            <TableRow>
              <StyledTableHeaderBoldCell>{t('SNo')}</StyledTableHeaderBoldCell>
              {columns
                    ...
                    {checkAccess(
                      ...
                      detailsView.isView && (
                        <StyledTableBodyCell style={{ textAlign: 'center' }}>
                          <Link
                            to={`/IncidentManagement/SearchIncidentEntry_Submitted/${row.IncidentId}`}
                            target="_blank"
