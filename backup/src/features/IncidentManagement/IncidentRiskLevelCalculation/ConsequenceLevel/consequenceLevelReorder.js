...
import ConsequenceLevelReorderTable from './ConsequenceLevelReorderTable'
import {
  useGetFieldsQuery,
  useGetLabelsQuery,
...
const ReorderIncidentType = () => {
  ...
  const tableColumnList = [
    // { id: 'Facility', translationId: 'Facility', isSelected: true },
    {
      ...
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_CL_P_ConsequenceLevel')?.IsShow,
    },
    {
      id: 'Score',
      translationId: 'IM_IRLC_L_Score',
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_CL_P_Score')?.IsShow,
    },
  ];
