...
import IncidentRiskLevelReordertable from './IncidentRiskLevelReordertable'
import {
  useGetFieldsQuery,
  useGetLabelsQuery,
...
const ReorderIncidentType = () => {
  ...
  const tableColumnList = [
    // { id: 'Facility', translationId: 'Facility', isSelected: true },
    {
      ...
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_IRL_P_IncidentRiskLevel')?.IsShow,
    },
    {
      id: 'ActionToBeTaken',
      translationId: 'IM_IRLC_IRL_ActionTobeTaken',
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_IRL_P_ActionTobeTaken')?.IsShow,
    },
    {
      id: 'ScoreRange',
      translationId: 'IM_IRLC_IRL_ScoreRange',
      isSelected: true,
      isShow: pageFields?.find((x) => x.FieldId === 'IRLC_IRL_P_ScoreRange')?.IsShow,
    },
  ];
