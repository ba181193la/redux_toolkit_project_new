...
import { setTeamTableData } from '../../../../../redux/features/mainMaster/incidentRcaSlice.js';
...
const ActionTable = ({ columns, labels, data }) => {
  ...
  console.log('teamdata:::', teamTableData);

  useEffect(() => {
    if (teamTableData && teamTableData.length > 0) {
      setTableData(teamTableData);
    }
  }, [teamTableData]);
  ...
  const handleSave = (r) => {
    ...
    dispatch(setTeamTableData(updatedRows));
