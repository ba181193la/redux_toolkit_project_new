...
const RejectedIncidentTable = () => {
  ...
  const totalRecords = dummyData.data.length;
  ...
  const handleClick = () => {
    navigate('/IncidentManagement/IncidentApprovalRejected');
  };
...
export default RejectedIncidentTable;
