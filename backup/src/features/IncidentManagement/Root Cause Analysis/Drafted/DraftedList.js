...
import RejectedIncidentTable from './DraftedIncidentTable';
import { useGetPageLoadDataQuery } from '../../../../redux/RTK/staffMasterApi';
import useWindowDimension from '../../../../hooks/useWindowDimension';
import FilterDraftedFields from './FilterDraftedFields';
    ...
    try {
      const blob = await triggerDownloadData({
        payload: {
          ...
          moduleId: selectedModuleId,
          menuId: selectedMenu?.id,
          locationId: locationFilterInitialValues?.locationId || 0,
          facilityIds:
            locationFilterInitialValues?.facilityId?.join(',').toString() || '',
        },
      }).unwrap();
