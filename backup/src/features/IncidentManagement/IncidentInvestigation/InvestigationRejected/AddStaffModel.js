...
const AddStaffModel = ({ open, onClose, setIsStaffModel, setStaffFacilityId, onSelectRow }) => {
                  ...
                  <FlexContainer padding="20px 20px 20px 0" alignItems="center">
                    <FlexContainer width="50%" gap="0px" alignItems="center">
                      ...
                      <Box sx={{ padding: '0 0 0 20px',width:"60%" }}>
                        {/* <Dropdown
                          name="facility"
                          options={facilityData?.Records?.map((facility) => ({
                          ...
                          required={true}
                          onChange={(e) =>
                            handleFacilityChange(e.target.value, setFieldValue)
                          }
                        /> */}
                        <SearchDropdown
                        ...
                        value={
                          userDetails?.ApplicableFacilities?.map((facility) => ({
                            text: facility.FacilityName,
                            value: facility.FacilityId,
                          }))?.find(
