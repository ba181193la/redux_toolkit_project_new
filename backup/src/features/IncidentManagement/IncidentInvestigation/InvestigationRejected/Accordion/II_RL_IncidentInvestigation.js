...
import II_PL_ActionTable from './Datatable/II_RL_ActionsTakenTable';
...
import II_PL_RequestOpinion from './II_RL_RequestOpinion';
import II_PL_EventSequence from './II_RL_EventSequence';
import II_RL_ReAssignOpinion from './II_RL_ReAssignOpinion';
...
import AttachmentTable from './Datatable/II_Rejected_AttachmentTable';
...
const IncidentInvestigationDetails = () => {
  ...
  const handleReAssignCancel = (cancel) => {
  ...
  const filteredOpinions = OpinionsSafe?.map((row, index) => ({
    OpinionId: row.OpinionId,
    RespondentName: row.RespondentName,
    DepartmentName: row.DepartmentName,
    DesignationName: row.DesignationName,
    OpinionComments: row.OpinionComments,
    OpinionUserId: row.OpinionUserId,
  ...
  const reAssignOpinionConfig = [
    {
      fieldId: `II_RORH_OpinionId`,
      translationId: 'IM_II_OpinionId',
      label: 'OpinionId',
      name: 'OpinionId',
    },
    {
      fieldId: `II_RORH_PreviousRespondentName`,
      translationId: 'IM_II_PreviousRespondentName',
      label: 'RespondentName',
      name: 'RespondentName',
    },
    {
      fieldId: `II_RORH_RespondentName`,
      translationId: 'IM_II_RespondentName',
      label: 'Department',
      name: 'DepartmentName',
    },
    ...
    // {
    //   fieldId: `II_RORH_ReasonForChange`,
    //   translationId: 'IM_II_ReasonForChange',
    //   label: 'Request',
    //   name: 'RequestorName',
    // },
    {
      fieldId: `II_P_OpinionComments`,
      translationId: 'IM_II_OpinionComments',
      label: 'Response',
      name: 'Response',
    },
  ];
        ...
        {showRejectInvestigation && (
          ...
          >
            ...
            >
              ...
              >
                Re-Assign Opinion Respondent
              </StyledTypography>
            </AccordionSummary>
            <II_RL_ReAssignOpinion
              columns={configs.reAssignOpinionConfig}
              labels={filterLabels}
              data={filteredOpinions}
              onCancelClick={handleReAssignCancel}
            />
          </Accordion>
        )}
