...
const IncidentHistory = ({columns, labels, data}) => {
       ...
       return (
        <FlexContainer flexDirection="column" width="100%" >
          <TableContainer component={Paper}>
            <Table >
              <StyledTableHead backgroundColor="#fd7272" borderLeft='none'>
                <StyledTableRow>
                  ...
                  <StyledTableHeaderCell color="#fff">Actions</StyledTableHeaderCell>
                </StyledTableRow>
              </StyledTableHead>
              <TableBody>
