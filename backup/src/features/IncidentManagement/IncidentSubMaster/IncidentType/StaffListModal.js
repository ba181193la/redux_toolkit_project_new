...
const StaffListModal = ({
  ...
  const staffListColumnsList = [
    ...
    },
    {
      ...
      isShow: pageFields?.find((x) => x.FieldId === 'IS_IT_P_EmployeeId')
        ?.IsShow,
    },
    {
      id: 'StaffName',
      translationId: 'IM_IS_IT_StaffName',
      isShow: pageFields?.find((x) => x.FieldId === 'IS_IT_P_StaffName')
        ?.IsShow,
    },
    {
      id: 'Department',
      translationId: 'IM_IS_IT_Department',
      isShow: pageFields?.find((x) => x.FieldId === 'IS_IT_P_Department')
        ?.IsShow,
    },
    {
      id: 'PrimaryDesignation',
      translationId: 'IM_IS_IT_Designation',
      isShow: pageFields?.find((x) => x.FieldId === 'IS_IT_P_Designation')
        ?.IsShow,
    },
  ];
