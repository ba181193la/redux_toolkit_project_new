...
import DefaultRoleTable from './DefaultRoleTable';
...
const designationColumns = [
  ...
  {
    id: 'SenderType',
    translationId: 'IM_NM_SenderType',
...
const NotificationMasterTable = () => {
  ...
  const columns = [
    {
      id: 'VariableName',
      translationId: 'IM_NM_PlaceHolders',
  ...
  const [triggerUpdateNotification] = useUpdateNotificationMutation();
      ...
      <Formik
        ...
        onSubmit={async () => {
          ...
          if (id) {
            ...
            navigate('/IncidentManagement/NotificationMaster');
          }
        }}
